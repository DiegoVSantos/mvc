...
<div class="container-fluid">
    <ul class="breadcrumb breadcrumb-tabs">
        ...
        <li>
            <a href="<?= SERVERURL ?>adminlist/" class="btn btn-success">
                <i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE ADMINISTRADORES
            </a>
        </li>
        <li>
            <a href="<?= SERVERURL ?>adminsearch/" class="btn btn-primary">
...
<div class="container-fluid">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form action="<?= SERVERURL ?>ajax/adminAjax.php" method="POST" data-form="save" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                <fieldset>
