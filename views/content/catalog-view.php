            ...
            <div class="list-group">
                <div class="list-group-item">
                    <div class="row-picture">
                        <img class="circle" src="<?= SERVERURL ?>views/assets/book/book-default.png" alt="icon">
                    </div>
                    <div class="row-content">
                        <h4 class="list-group-item-heading">1 - Título completo del libro</h4>
                        <p class="list-group-item-text">
                            <strong>Autor: </strong>Nombre Autor del libro <br>
                            <a href="<?= SERVERURL ?>bookinfo/" class="btn btn-primary" title="Más información"><i class="zmdi zmdi-info"></i></a>
                            ...
                            <a href="<?= SERVERURL ?>book-config/" class="btn btn-primary" title="Gestionar libro"><i class="zmdi zmdi-wrench"></i></a>
                        </p>
                    </div>
                </div>
                ...
                <div class="list-group-item">
                    <div class="row-picture">
                        <img src="<?= SERVERURL ?>views/assets/book/book-cover.jpg" alt="icon">
                    </div>
                    <div class="row-content">
                        ...
                        <p class="list-group-item-text">
                            ...
                            <a href="#!" class="btn btn-primary" title="Ver PDF"><i class="zmdi zmdi-file"></i></a>
                            <a href="#!" class="btn btn-primary" title="Descargar PDF"><i class="zmdi zmdi-cloud-download"></i></a>
                            <a href="<?= SERVERURL ?>bookconfig/" class="btn btn-primary" title="Gestionar libro"><i class="zmdi zmdi-wrench"></i></a>
                        </p>
                    </div>
                </div>
                <div class="list-group-separator"></div>
